...
public class SoundsList {
   ...
   public static String[] soundFiles = new String[]{"gravisuite/audio/sounds/tools/drill/DrillHard.ogg", "gravisuite/audio/sounds/tools/drill/DrillSoft.ogg", "gravisuite/audio/sounds/tools/drill/DrillUseLoop.ogg"};
