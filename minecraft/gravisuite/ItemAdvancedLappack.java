...
public class ItemAdvancedLappack extends ItemArmor implements IArmorTextureProvider, IElectricItem, IMetalArmor, ISpecialArmor {

   public static int maxCharge;
   private int transferLimit;
   private int tier;

   public ItemAdvancedLappack(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
   ...
   public String getArmorTextureFile(ItemStack itemstack) {
      return "/gravisuite/advanced_lappack.png";
   }
