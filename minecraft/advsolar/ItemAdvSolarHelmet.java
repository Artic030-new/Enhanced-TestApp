...
public class ItemAdvSolarHelmet extends ItemArmor implements IArmorTextureProvider, IElectricItem, IMetalArmor, ISpecialArmor {
   ...
   public ItemAdvSolarHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4, int htype) {
   ...
   public String getArmorTextureFile(ItemStack itemstack) {
      return "/advsolar/texture/advancedSolarHelmet.png";
   }
