...
public class ItemSolarHelmet extends ItemArmor implements IArmorTextureProvider, IElectricItem, IMetalArmor, ISpecialArmor {
   ...
   public ItemSolarHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4, int htype) {
