...
public class ContainerSingularityCompressor extends Container {
   ...
   public ContainerSingularityCompressor(InventoryPlayer inv, TileEntitySingularityCompressor tE) {
      this.tileentity = tE;
      this.addSlotToContainer(new Slot(tE, 0, 56, 53));
      this.addSlotToContainer(new Slot(tE, 1, 56, 17));
      this.addSlotToContainer(new SlotFurnace(inv.player, tE, 2, 115, 35));
      this.addSlotToContainer(new Slot(tE, 3, 152, 6));
      this.addSlotToContainer(new Slot(tE, 4, 152, 24));
      this.addSlotToContainer(new Slot(tE, 5, 152, 42));
      this.addSlotToContainer(new Slot(tE, 6, 152, 60));
