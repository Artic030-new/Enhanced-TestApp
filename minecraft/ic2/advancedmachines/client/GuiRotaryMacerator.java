...
public class GuiRotaryMacerator extends GuiContainer {
   ...
   public GuiRotaryMacerator(InventoryPlayer player, TileEntityRotaryMacerator tileentity) {
      super(new ContainerRotaryMacerator(player, tileentity));
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTick, int mouseX, int mouseY) {
      int var4 = super.mc.renderEngine.getTexture("/ic2/advancedmachines/client/sprites/GUIRotary.png");
