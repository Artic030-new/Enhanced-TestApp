...
public final class Ic2Recipes {
   ...
   public static void addCraftingRecipe(ItemStack result, Object ... args) {
      try {
         Class.forName(getPackage() + ".core.AdvRecipe").getMethod("addAndRegister", new Class[]{ItemStack.class, Array.newInstance(Object.class, 0).getClass()}).invoke((Object)null, new Object[]{result, args});
   ...
   public static void addShapelessCraftingRecipe(ItemStack result, Object ... args) {
      try {
         Class.forName(getPackage() + ".core.AdvShapelessRecipe").getMethod("addAndRegister", new Class[]{ItemStack.class, Array.newInstance(Object.class, 0).getClass()}).invoke((Object)null, new Object[]{result, args});
      } catch (Exception var3) {
         throw new RuntimeException(var3);
      }
   }
   ...
   public static List getScrapboxDrops() {
      try {
         return (List)Class.forName(getPackage() + ".core.item.ItemScrapbox").getMethod("getDropList", new Class[0]).invoke((Object)null, new Object[0]);
      } catch (Exception var1) {
         throw new RuntimeException(var1);
      }
   }
   ...
   public static void addScrapboxDrop(ItemStack dropItem, float chance) {
      try {
         Class.forName(getPackage() + ".core.item.ItemScrapbox").getMethod("addDrop", new Class[]{ItemStack.class, Float.TYPE}).invoke((Object)null, new Object[]{dropItem, Float.valueOf(chance)});
      } catch (Exception var3) {
         throw new RuntimeException(var3);
      }
   }
   ...
   public static void addMatterAmplifier(ItemStack amplifierItem, int value) {
      getMatterAmplifiers().add(new SimpleEntry(amplifierItem, Integer.valueOf(value)));
   }
